...
export default function QuizPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Subscription Score Quiz - Subsecute</title>
        <meta
          name="description"
          content="Take the Subsecute Subscription Score quiz. 7 questions, 60 seconds. Find out if you're in control of your subscriptions — or in chaos."
        />
        <link rel="canonical" href="https://subsecute.com/quiz" />
        <meta property="og:title" content="What's Your Subscription Score? - Subsecute" />
        <meta
          property="og:description"
          content="7 questions. 60 seconds. Find out if you're in control — or in chaos."
        />
        <meta property="og:url" content="https://subsecute.com/quiz" />
