...
export default function FamilyPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Family Cost Calculator — Subsecute</title>
        <meta
          name="description"
          content="See how much you really spend on family bills back home. Calculate your DSTV, airtime, data, electricity and more. Built for diaspora Nigerians."
        />
        <link rel="canonical" href="https://subsecute.com/family" />

        <meta property="og:title" content="How much does supporting your family cost you? — Subsecute" />
        <meta
          property="og:description"
          content="See the real cost of every bill you pay for family back home. DSTV, airtime, data, electricity and more."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://subsecute.com/family" />
        <meta property="og:site_name" content="Subsecute" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="How much does supporting your family cost you? — Subsecute" />
        <meta
          name="twitter:description"
          content="See the real cost of every bill you pay for family back home."
        />
      </Helmet>
