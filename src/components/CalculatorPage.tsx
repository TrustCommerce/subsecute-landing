...
export default function CalculatorPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Naira Leak Calculator — How much are you spending on subscriptions? | Subsecute</title>
        <meta
          name="description"
          content="Find out how much Naira is leaking from your account on subscriptions and bills every year. Free calculator by Subsecute."
        />
        <link rel="canonical" href="https://subsecute.com/calculator" />
        <meta property="og:title" content="How much Naira is leaking from your account?" />
        <meta
          property="og:description"
          content="Tap every subscription and bill you pay for. The annual total might surprise you."
        />
        <meta property="og:url" content="https://subsecute.com/calculator" />
      ...
      <div className="min-h-screen bg-[#FFFEEC]">
        ...
        <nav className="px-4 pt-5 lg:px-[100px]">
          <div className="relative z-50 mx-auto flex max-w-[1240px] items-center justify-between rounded-xl border border-[#DEE2E6] px-5 py-2.5">
            <Link to="/" aria-label="Subsecute home">
